...
![Size](https://img.shields.io/badge/Size-392Mo-f12222)
...
The distribution of the final scores seems a bit too low for the first journals and a bit too high for the last ones compared to the metrics. To correct this, the same steps as described above (ranking + transformation) are also implemented, but here the result is combined with the initial score instead of replacing it:
...
The final scores are stored in the **[/journals.csv](/journals.csv)** file, run the **[/scores.ipynb](/scores.ipynb)** notebook to update it.
